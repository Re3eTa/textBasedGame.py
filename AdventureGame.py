...
def adventureGameMain():
    def first_phase():
        print("\nwelcome to 'delinquents-computing' Main testing facility.")
        ...
        print("Announcer: Xen computing is a new form of super-computer that links the users brain to the CPU to achieve levels of computing  never seen before. these trials will commence in our top secret level located 400m under the facility.")
        ...
        print("\nleaving the vehicle you now recognise as a boarded up sleek looking train, you see an entryway with some vending machines.")
        ...
        if(roomChoice == 'vending machine'):
          ...
          ###prompt first optional choice path
            ...
            if(vendingChoice == 'buttons'):
                ...
                if(coceChoice == 'elevator'):
                    ...
                    ### idk I used to punch vending machines as a kid beacause one time it worked
                ...
                ### same punch story sorta
            
                print("\nyou remember your history with these god forsaken 'vending machines' (it is not good.) and give the machine the uppercut of a lifetime.")
                ...
                ### skips healing mechanic (i though some people might find this extra path to be tedious so theres multiple ways to skip it)
            ...
            ### skips vending path entirely for unique text
        ...
        if(elevator & coce == True):
            ...
            ### discovers op healing from 'coce'
            ...
            ### endures quiet ride down elevator
